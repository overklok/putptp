...
$config = [
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'RJwIRyQ8YcP1gERKOHAbGnBu4UYu8eMo',
        ...
        'view' => [
            'theme' => [
                'basePath' => '@app/themes/prod',
                'baseUrl' => '@app/themes/prod',
                'pathMap' => [
                    '@app/views' => '@app/themes/prod',
                    '@app/modules' => '@app/themes/prod/modules',
                ]
            ]
]
    ],
